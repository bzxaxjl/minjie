            ...
            <div class="ibox ">
                ...
                <div class="ibox-content">
                    ...
                    <div class="navbar-header">
                        <form role="search" class="navbar-form-custom" method="post" action="${pageContext.request.contextPath}/VideoController/admingetVideoByName">
                            ...
                            <c:forEach var="item" items="${videolist}">
                                <tr class="gradeX">
                                    ...
                                    <td class="center"><!-- play modal -->
                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal" onclick="changeVideosrc('${item.video_src}')">查看</button>
                                    </td>
                                    <td class="center"><!-- delete modal -->
                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal1" onclick="deleteVideo('${item.video_id}')">删除</button>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
...
<script>
    ...
    function deleteVideo(video_id) {
        window.location.href = "${pageContext.request.contextPath}/VideoController/adminDeleteVideo?video_id="+video_id;
    }
</script>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <%--src:这个数据是动态的，通过脚本设置--%>
                <video id="videosrc" src="" controls autoplay width="300" height="500"></video>
            </div>

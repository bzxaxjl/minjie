                ...
                <div class="ibox-content">
                    ...
                    <div class="jqGrid_wrapper">
                        <table class="footable table table-stripped table-hover" data-page-size="8" data-filter=#filter>
                            ...
                            <!--数据体 开始-->
                            <tbody>
                            <c:forEach var="item" items="${audiorecyclelist}">
                                <tr class="gradeX">
                                    <td>${item.audio_id}</td>
                                    ...
                                    <td class="center"><!-- delete modal -->
                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal1" onclick="restoreAudio('${item.audio_id}')">还原</button>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
...
<script>
    ...
    function restoreAudio(audio_id) {
        window.location.href = "${pageContext.request.contextPath}/AudioController/adminRestoreAudio?audio_id="+audio_id;

            ...
            <div class="ibox ">
                ...
                <div class="jqGrid_wrapper">
                    <table class="footable table table-stripped table-hover" data-page-size="8" data-filter=#filter>
                        ...
                        <!--数据体 开始-->
                        <tbody>
                        <c:forEach items="${audiolist}" var="item" >
                            <tr class="gradeX">
                                <td>${item.audio_id}</td>
                                ...
                                <td class="center">
                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal"
                                            onclick="deleteaudio(${item.audio_id})">删除</button>
                                </td>
                            </tr>
                        </c:forEach>
                        </tbody>
...
<script>
    ...
    * */
    ...
    function deleteaudio(audio_id) {
        window.location.href="${pageContext.request.contextPath}/AudioController/deleteAudio?audio_id="+audio_id;
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">音频查看</h4>
            </div>
            <div class="modal-body">
                <audio id="audiosrc" src="" controls width="500px" ></audio>
            </div>

            ...
            <div class="ibox ">
                ...
                <div class="jqGrid_wrapper">
                    <table class="footable table table-stripped table-hover" data-page-size="8" data-filter=#filter>
                        ...
                        <!--数据体 开始-->
                        <tbody>
                        <c:forEach items="${restoreaudiolist}" var="item" >
                            <tr class="gradeX">
                                <td>${item.audio_id}</td>
                                ...
                                <td class="center">
                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal"
                                            onclick="changeAudiosrc('${item.audio_src}')">查看</button>
                                </td>
                                <td class="center">
                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal"
                                            onclick="restoreaudio(${item.audio_id})">还原</button>
                                </td>
                            </tr>
                        </c:forEach>
                        </tbody>
...
<script>
    ...
    * */
    ...
    function restoreaudio(audio_id) {
        alert("${msg}");
        window.location.href="${pageContext.request.contextPath}/AudioController/restoreAudio?audio_id="+audio_id;
    }
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <audio id="audiosrc" src="" controls width="500px" height="300px"></audio>
            </div>

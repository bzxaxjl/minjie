        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    <form method="get" onsubmit="return checkip()" class="form-horizontal" action="${pageContext.request.contextPath}/LoginController/updateBusinessUser">
                        ...
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">商铺性名</label>
                        ...
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">商铺法人</label>
                        ...
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">商铺法人电话</label>
...
<script>
    $.ajax({
        type: "POST",
        url: "${pageContext.request.contextPath}/BusinessLoginController/selectBusinessUserByid",
